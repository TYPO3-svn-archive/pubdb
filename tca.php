...
$TCA['tx_pubdb_data'] = Array (
	...
	'columns' => Array (
		...
		'parent_pubid' => Array(
			'exclude' => 1,
			'label' => 'LLL:EXT:pubdb/locallang_db.xml:tx_pubdb_data.parent',	
		...
		'number' => Array (		
			...
			'displayCond' => 'FIELD:pubtype:IN:journal,book,conference_proceedings',		
			'config' => Array (
				'type' => 'input',	
				'size' => '10',
                                'max' => '10'
		...
		'issue' => Array (		
			...
			'displayCond' => 'FIELD:pubtype:IN:journal,conference_proceedings',
			'config' => Array (
				'type' => 'input',	
				'size' => '10',
                                'max' => '10'
...
$TCA['tx_pubdb_pub_contributors'] = Array(
	...
	'feInterface' => $TCA['tx_pubdb_pub_contributors']['feInterface'],
	'columns' => Array(
		'pubid' => Array(
			'label' => 'Publication',
			'config' => Array(
...
// NOTE: for the following fields text is used instead of input due to a bug in typo3 core which is not fixed
// yet in the most current version (6.1)		
		'organization' => Array (		
			'exclude' => 1,
